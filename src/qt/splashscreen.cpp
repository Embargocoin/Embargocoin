    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText3  = QChar(0xA9)+QString(" 2014 ") + QString(tr("The EmbargoCoin Developers"));
	QString copyrightText4  = QChar(0xA9)+QString(" 2014-%1 ") + QString(tr("The EmbargoCoin Developers"));
